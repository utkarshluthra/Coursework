...
// specifies the attributes and behaviours of a player. 
class Player {
    private String name;
    private int guess;
    private int score;
    ...
    public void setRoundScore(int r){
        roundScore = r;
    }
    public void addRoundScore(int r){
        roundScore += r;
    }
}

// To generate random numbers for key and for abandoningvalue
class NumberGenerator {
    public int genRandom(){
        int key = (int)(Math.random()*(100)+1);
        return key;
    }
    public int genRandom20(){
        int key20 = (int)(Math.random()*(20)+1);
        return key20;
    }
}

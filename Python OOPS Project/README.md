**This assignment is a simple emulation of data processing. Your application should be
able to ask the user to input username, password to login into your system. The
system should be able to identify the role of this user and allow corresponding
operations.**

This is an individual assignment and must be your own work.

The allowed libraries are random, math, os and re. You will not receive marks for the
components if you use any other libraries apart from the mentioned library.
